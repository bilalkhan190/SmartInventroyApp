...
public sealed class ApprovePurchaseOrderHandler
    : IRequestHandler<ApprovePurchaseOrderCommand, HandlerResult<PurchaseOrderDto>>
{
    private readonly IApplicationDbContext _context;

    public ApprovePurchaseOrderHandler(IApplicationDbContext context)
    {
        _context = context;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            // Business rules + domain event live on the aggregate
